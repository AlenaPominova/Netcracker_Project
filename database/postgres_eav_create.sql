CREATE SEQUENCE public."uid_sequence"
    ...
    CACHE 1;
ALTER SEQUENCE public."uid_sequence"
    OWNER TO postgres;
  

CREATE TABLE "OBJECTS" (
	"object_id" bigint NOT NULL DEFAULT nextval('uid_sequence'),
...
CREATE TABLE "OBJECT_TYPES" (
	"object_type_id" bigint NOT NULL DEFAULT nextval('uid_sequence'),
	"name" character varying NOT NULL,
...
CREATE TABLE "ATTRIBUTES" (
	"attr_id" bigint NOT NULL DEFAULT nextval('uid_sequence'),
...
CREATE TABLE "ATTR_TYPES" (
	"attr_type_id" bigint NOT NULL DEFAULT nextval('uid_sequence'),
	"name" character varying NOT NULL,
...
CREATE TABLE "LIST_VALUES" (
	"list_value_id" bigint NOT NULL DEFAULT nextval('uid_sequence'),
	"attr_id" bigint NOT NULL,
...
ALTER TABLE "OBJECTS" ADD CONSTRAINT "OBJECTS_fk1" FOREIGN KEY ("parent_id") REFERENCES "OBJECTS"("object_id");
