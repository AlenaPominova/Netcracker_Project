...
public class Obj {
    ...
    public Obj(String id, String name, long typeId, String parentId) {
        this.id = id;
        this.name = name;
        this.typeId = typeId;
    ...
    public boolean equals(Object o) {
        ...
        return typeId == obj.typeId &&
                ...
                Objects.equals(parentId, obj.parentId) &&
    ...
    public int hashCode() {
        ...
        return Objects.hash(id, name, typeId, parentId, description, values, dateValues, listValues, references);
    }
}
