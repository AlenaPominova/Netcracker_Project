...
public class PostgresSQLQueries {
    ...
    public static final String SAVE_OBJECT_QUERY =
            "INSERT INTO \"OBJECTS\"(object_id, object_type_id, name, description) VALUES (?, ?, ?, ?)\n" +
                    "ON CONFLICT (object_id) DO UPDATE SET name = ?";
    ...
    public static final String SET_REFERENCE_PARAM_QUERY =
            "INSERT INTO \"REFERENCES\" (attr_id, reference, object_id) values (?, ?, ?)\n" +
                    "                    ON CONFLICT (attr_id, object_id) DO UPDATE SET reference = ?\n" +
                    "                    ;";
    ...
    public static final String GET_ATTRIBUTES_INFO =
            "SELECT a.attr_id, a.name\n" +
                    "FROM \"ATTRIBUTES\" a";

    public static final String GET_OBJECT_ID_BY_LOGIN =
